...
$(document).ready(function () {
  ...
  function swipe1(el, d) {
    if (d != "" && d == "right") {
      ...
      $(".pricing_prev_button").click();
    } else if (d != "" && d == "left") {
      // swiped left
      console.log("#1 swiped left");
      $(".pricing_next_button").click();
    }
  }
  function swipe2(el, d) {
    if (d != "" && d == "right") {
      ...
      $(".pricing_prev_button_2").click();
    } else if (d != "" && d == "left") {
      // swiped left
      console.log("#2 swiped left");
      $(".pricing_next_button_2").click();
    }
  }
  ...
  const handleClick1 = function (btn) {
    if (window.innerWidth < 480) {
      console.log("<480 running");
      if (btn === "prev" && pricingSlide1Index > 1) {
        console.log("<480 running prev");
